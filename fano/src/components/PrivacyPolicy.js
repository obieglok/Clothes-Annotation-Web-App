        ...
        <div className="register">
          <div className="lgn details">
            ...
            <div className= "terms policy">
              ...
              <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank" rel="noopener noreferrer">Privacy Policy Generator</a>.</p>
              ...
              <li>
              <p><h5>Application</h5> means the software program provided by the Company downloaded by You on any electronic device, named Fano</p>
              </li>
              <li>
              <p><h5>Company</h5> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Fano, Dublin.</p>
              </li>
              <li>
              <p><h5>Country</h5> refers to:  Ireland</p>
              </li>
              <li>
              ...
              <li>
              <p><h5>Third-party Social Media Service</h5> refers to any website or any social network website through which a User can log in or create an account to use the Service.</p>
              </li>
              <li>
              ...
              <ul>
              <li><h5>With Service Providers:</h5> We may share Your personal information with Service Providers to monitor and analyze the use of our Service,  to contact You.</li>
              <li><h5>For business transfers:</h5> We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to another company.</li>
              <li><h5>With Affiliates:</h5> We may share Your information with Our affiliates, in which case we will require those affiliates to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint venture partners or other companies that We control or that are under common control with Us.</li>
              <li><h5>With business partners:</h5> We may share Your information with Our business partners to offer You certain products, services or promotions.</li>
              <li><h5>With other users:</h5> when You share personal information or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside. If You interact with other users or register through a Third-Party Social Media Service, Your contacts on the Third-Party Social Media Service may see Your name, profile, pictures and description of Your activity. Similarly, other users will be able to view descriptions of Your activity, communicate with You and view Your profile.</li>
              <li><h5>With Your consent</h5>: We may disclose Your personal information for any other purpose with Your consent.</li>
              </ul>
              ...
              <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We h5ly advise You to review the Privacy Policy of every site You visit.</p>
              ...
              <ul>
              <li>By visiting this page on our website: <a href="https://fano.com/contact" rel="external nofollow noopener noreferrer" target="_blank">https://fano.com/contact</a></li>
              </ul>
            </div>
            </div>
